...
//GENERATE USER
    ...
    public void testEditNonAuthorizedUser() {
        ...
        Response responseEditNoAuthUser = apiCoreRequests
                .makePutRequestEditNoAuthUser("https://playground.learnqa.ru/api_dev/user/" + userId,
                        editData,
                        wrongToken,
                        wrongCookie);
    ...
    public void testEditAnotherUser() {
        ...
        Response responseEditUser = apiCoreRequests
                .makePutRequestEditUser("https://playground.learnqa.ru/api_dev/user/" + userId,
                        editData,
                        this.header,
                        this.cookie);
    ...
    public void testEditUserInvalidEmail() {
        ...
        Response responseEditUser = apiCoreRequests
                .makePutRequestEditInvalidEmail("https://playground.learnqa.ru/api_dev/user/" + userId,
                        editData,
                        token1,
                        cookie1);
        ...
        //GET
        Response responseUserData = apiCoreRequests
                .makeGetRequestInvalidFirstName("https://playground.learnqa.ru/api_dev/user/" + userId,
                        token1,
                        cookie1);
